...
from ..constants import IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, DEFAULT_VIDEO_TOKEN
from ..conversation import conv_templates, SeparatorStyle
from ..model.builder import load_pretrained_model
from ..utils import disable_torch_init
from ..mm_utils import tokenizer_image_token, process_videos, get_model_name_from_path, tokenizer_special_token
...
def eval_model(args):
    ...
    for line in tqdm(questions):
        ...
        results.append({"question_id": question_id, "answer": outputs})
